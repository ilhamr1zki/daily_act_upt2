...
//echo $kodseq;
    ...
    //$c_siswa
    $akh=mysqli_query($con,"INSERT INTO siswa set c_siswa='$kodseq',c_kelas='$c_kelas',nisn='$nisn',nama='$nama',jk='$jk',temlahir='$alamatlahir',
...
//guru
  function addteacher($con,$c_guru,$nip,$nama,$alamat,$tl,$username,$password, $tgl_join, $c_jabatan,
  ...
  function editguru($con,$c_guru,$nip,$nama,$alamat,$tl,$username, $tgl_join, $c_jabatan,
                    $jkel, $alamatlengkap, $pendidikan, $jurusan, $email){
    $akh=mysqli_query($con,"UPDATE guru set nip='$nip',nama='$nama',temlahir='$alamat',tanglahir='$tl'
    ,username='$username', tgl_join = '$tgl_join', c_jabatan = '$c_jabatan',
    jkel = '$jkel', alamat = '$alamatlengkap', pendidikan = '$pendidikan', jurusan = '$jurusan',
    email = '$email'
     where c_guru='$c_guru' ");
