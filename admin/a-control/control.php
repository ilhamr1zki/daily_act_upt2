...
//siswa
    ...
    // echo htmlspecialchars($_POST['nama']);exit;


    $smk->addsiswa($con,$c_siswa,$_POST['c_kelas'],htmlspecialchars($_POST['nisn']), mysqli_real_escape_string($con, htmlspecialchars($_POST['nama'])),$_POST['jk'], mysqli_real_escape_string($con, htmlspecialchars($_POST['alamat'])), htmlspecialchars($tl), 
    htmlspecialchars($_POST['_thnjoin']) ?? 0, mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmpanggilan'])) ?? "", htmlspecialchars($_POST['_klpselect']) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_beratbadan']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_tinggibadan']) ) ?? "",
    mysqli_real_escape_string($con, htmlspecialchars($_POST['_ukuranbaju']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_alamatrumah']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_telp']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_hp']) ) ?? "", htmlspecialchars($_POST['_email']) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmayah'])) ?? "",
    $_POST['_pendayah'] ?? "", $_POST['_pekerjaanayah'] ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_temptglayah'])) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmibu'])) ?? "", htmlspecialchars($_POST['_pendibu']) ?? "",
    mysqli_real_escape_string($con, htmlspecialchars($_POST['_pekerjaanibu']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_temptglibu'])) ?? "", htmlspecialchars($_POST['_nis']) ?? "");
  }
  else if($akh==md5('editsiswa')){ $tl=date('Y-m-d',strtotime($_POST['tl'] ?? "1900-01-01"));
    $smk->editsiswa($con,$_POST['c_siswa'], htmlspecialchars($_POST['_nis']) ?? "", htmlspecialchars($_POST['nisn']) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['nama'])),$_POST['jk'] ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['alamat'])) ?? "", htmlspecialchars($tl), 
    htmlspecialchars($_POST['_thnjoin']) ?? 0, mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmpanggilan'])) ?? "", htmlspecialchars($_POST['_klpselect']) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_beratbadan']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_tinggibadan']) ) ?? "",
    mysqli_real_escape_string($con, htmlspecialchars($_POST['_ukuranbaju']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_alamatrumah']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_telp']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_hp']) ) ?? "", htmlspecialchars($_POST['_email']) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmayah'])) ?? "",
    $_POST['_pendayah'] ?? "", $_POST['_pekerjaanayah'] ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_temptglayah'])) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_nmibu'])) ?? "", htmlspecialchars($_POST['_pendibu']) ?? "",
    mysqli_real_escape_string($con, htmlspecialchars($_POST['_pekerjaanibu']) ) ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_temptglibu'])) ?? "", htmlspecialchars($_POST['_kelasselect']) ?? "");
  }
//guru
  else if($akh==md5('addguru')){ 
    $c_guru=random(9); 
    $tl=date('Y-m-d',strtotime($_POST['tl']));
    $tgljoin=date('Y-m-d',strtotime($_POST['tgljoin'] ?? "1900-01-01"));
    // echo htmlspecialchars($_POST['_jurusan']);exit;

    $patternSpecialCase = "/'/i";

    $foundData          = preg_match($patternSpecialCase, $_POST['jabatan']);
    // echo $foundData;exit;

    if ($foundData == 1) {

      $_SESSION['pesanx'] = 'jabatan';
      header('location:../../addguru');

    } else if ($foundData == 0) {

      $smk->addguru($con,$c_guru,$_POST['nip'], mysqli_real_escape_string($con, htmlspecialchars($_POST['nama'])), mysqli_real_escape_string($con,htmlspecialchars($_POST['alamat'])) ?? "",
    $tl, htmlspecialchars($_POST['username']),password_hash(htmlspecialchars($_POST['password']), PASSWORD_DEFAULT), $tgljoin, mysqli_real_escape_string($con, htmlspecialchars($_POST['jabatan'])) ?? "", $_POST['jk'] ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_alamatrumah'])) ?? "",
    $_POST['_pendidikan'] ?? "", mysqli_real_escape_string($con,htmlspecialchars($_POST['_jurusan'])) ?? "", htmlspecialchars($_POST['_email']) ?? "");
    ...
    if ($foundData == 1) {
      ...
      $_SESSION['pesanx'] = 'jabatan';
      header('location:../../editguru/'.$_POST['c_guru'].'');

    } elseif ($foundData == 0) {

      $tl=date('Y-m-d',strtotime($_POST['tl']));$tgljoin=date('Y-m-d',strtotime($_POST['tgljoin'] ?? "1900-01-01"));
      $smk->editguru($con,$_POST['c_guru'],$_POST['nip'], mysqli_real_escape_string($con, htmlspecialchars($_POST['nama'])) ?? "", mysqli_real_escape_string($con,htmlspecialchars($_POST['alamat'])) ?? "",
      $tl, htmlspecialchars($_POST['username']), $tgljoin, mysqli_real_escape_string($con, htmlspecialchars($_POST['jabatan'])) ?? "", $_POST['jk'] ?? "", mysqli_real_escape_string($con, htmlspecialchars($_POST['_alamatrumah'])) ?? "",
      $_POST['_pendidikan'] ?? "", mysqli_real_escape_string($con,htmlspecialchars($_POST['_jurusan'])) ?? "", htmlspecialchars($_POST['_email']) ?? "");
