<?php  
    ...
    if ($timeRunningOut == $timeOut || $timeRunningOut > $timeOut) {
        ...
        $dataPasswordLama   = mysqli_query($con, "SELECT * FROM admin WHERE c_admin = '$_SESSION[key_admin_paud]' "); 
        ...
        if (password_verify($dataInputPasswordLama, $getPassword)) {
            ...
            if (strlen($dataInputPasswordBaru) < 5 || strlen($dataInputKonfirmasiPassword) < 5) {
                ...
                if ($dataInputPasswordBaru == $dataInputKonfirmasiPassword) {
                    ...
                    $updateNewPassword = mysqli_query($con, "UPDATE admin SET password = '$generatePassword' WHERE c_admin = '$_SESSION[key_admin_paud]' ");
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" required class="form-control" name="password_lama" placeholder="password sekarang" id="password_lama">
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" required class="form-control" name="password_baru" placeholder="Minimal 5 Karakter" id="password_baru">
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="password" required class="form-control" name="konfirmasi_password_baru" placeholder="Minimal 5 Karakter" id="konf_password_baru">
                    </div>
