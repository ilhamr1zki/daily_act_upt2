...
<script type="text/javascript">
    ...
    newIcon.classList.add("glyphicon-text-width");

    let getTitleList2 = document.getElementById('isiList3').innerHTML;
